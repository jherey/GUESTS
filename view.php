	...
	<div class="container">
		<div class="jumbotron" style="width: 70%; margin: auto;">
			<?php
				...
				echo "<td><a href=\"view.php?id=$res[id]\" class=\"btn btn-success btn-md butt\"><span class=\"glyphicon glyphicon-info-sign\"></span> View</a>  <a href=\"edit.php?id=$id\" class=\"btn btn-info btn-md butt\"><span class=\"glyphicon glyphicon-edit\"></span> Edit</a>  <a href=\"delete.php?id=$id\" class=\"btn btn-danger btn-md\" onClick=\"return confirm('Are you sure you want to delete?')\"><span class=\"glyphicon glyphicon-trash\"></span> Delete</a></td>";	
			?>
		</div>
	</div>
